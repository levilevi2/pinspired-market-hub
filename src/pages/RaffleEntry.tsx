...
ניתן להעביר לחבר או משפחה את הזכייה</p>
            ...
            <Button onClick={handleRaffleRegistration} className="w-full mt-8 modern-button backdrop-blur-sm border border-white/30 text-white text-lg h-auto bg-orange-500 hover:bg-orange-400 py-[2px] my-[9px] px-[27px] mx-px">
              הירשם להגרלה
            </Button>
          </div>
        </Card>
