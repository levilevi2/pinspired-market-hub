          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-lg shadow-md text-center">
              ...
              <div className="space-y-4">
                <Button onClick={handleRegisterRedirect} className="w-full bg-black hover:bg-gray-800 text-white">
                  עבור להרשמה
                </Button>
            ...
            <div className="mt-8 bg-white/5 backdrop-blur-md p-6 rounded-lg shadow-md opacity-60">
              ...
              <div className="space-y-3">
                {items.map(item => <div key={item.id} className="flex gap-4 bg-white/5 p-3 rounded-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                {items.map(item => <div key={item.id} className="flex flex-col sm:flex-row gap-4 bg-white/5 p-4 rounded-lg">
                    <img src={item.image} alt={item.title} className="w-24 h-24 rounded-md object-fill" />
                    ...
                    <div className="flex flex-col items-center gap-3">
                      <div className="flex items-center border border-white/20 rounded-md bg-white/5">
                        <Button variant="ghost" size="sm" className="text-white hover:text-white hover:bg-white/10 px-2" onClick={() => updateQuantity(item.id, item.quantity - 1)}>
                          <Minus size={16} />
                        </Button>
                        <span className="px-4 text-white">{item.quantity}</span>
                        <Button variant="ghost" size="sm" className="text-white hover:text-white hover:bg-white/10 px-2" onClick={() => updateQuantity(item.id, item.quantity + 1)} disabled={item.category === "discounted-flight" && item.quantity >= 2}>
                          <Plus size={16} />
                        </Button>
                      </div>
                      
                      <Button variant="ghost" size="sm" className="text-red-400 hover:text-red-300 hover:bg-red-900/20" onClick={() => removeFromCart(item.id)}>
                        <Trash2 size={16} />
                      </Button>
                    </div>
                  </div>)}
          ...
          <div>
            <div className="bg-white/10 backdrop-blur-md p-6 rounded-lg shadow-md sticky top-6">
              ...
              {step === "user-details" ? <div className="space-y-3" dir="rtl">
                  ...
                  <div>
                    ...
                    <Textarea id="address" name="address" value={userDetails.address} onChange={handleInputChange} className="bg-white/10 border-white/20 text-white" dir="rtl" />
                  </div>
                </div> : <div className="space-y-3" dir="rtl">
              ...
              <Button className="w-full mt-6 bg-black hover:bg-gray-800 text-white flex items-center gap-2" onClick={handleCheckout} disabled={!isAuthenticated}>
